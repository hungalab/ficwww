...
### /runcmd
Run command in RPi3 raspbian

#### POST METHOD
* Note: This feature has a lot of security issue
* If you want to disable this please set ENABLE_RUNCMD_API=False in ficwww.py
* Default command timeout is 5sec
